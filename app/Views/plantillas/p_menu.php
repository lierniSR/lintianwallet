    ...
    <nav class="w-full px-4 sm:px-6 lg:px-12">
        <div class="flex justify-between h-16 items-center">
            ...
            <ul class="hidden md:flex space-x-6 items-center">
                <li>
                    <a href="<?= base_url('tarjetas') ?>" class="flex items-center gap-2 text-gray-600 hover:text-purple-600 font-semibold transition-colors duration-200">
                ...
                <li>
                    <a href="<?= base_url('ingresos') ?>" class="flex items-center gap-2 text-gray-600 hover:text-purple-600 font-semibold transition-colors duration-200">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
